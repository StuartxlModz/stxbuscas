...
<form method="GET">
<input name="cpf" class="valueConsulta" type="text" placeholder="NOME EX. Jair Messias Bolsonaro">
<span style="width: 70%;">
<div>
...
if(isset($_GET['consultar'])){
    $cpf = $_GET["cpf"];
    $cpf = str_replace(' ', '%20', $cpf);


    $curl = curl_init();
    curl_setopt_array($curl, [
        CURLOPT_URL => "https://pkyha.localtonet.com/nome.php?nome=" . $cpf,
...
<tr bgcolor="#202020"><td colspan="2"><b>Nome:</b></td><td colspan="2"><b>Sexo</b></td></tr>
<tr><td colspan="2"><?= $json->nome ?></td><td colspan="2"><?= $json->sexo; ?></td></tr>
<tr bgcolor="#202020"><td colspan="2"><b>Data Nascimento:</b></td><td colspan="2"><b>CPF:</b></td></tr>
<tr><td colspan="2"><?= $json->nascimento; ?></td><td colspan="2"><?= $json->cpf; ?></td></tr>
<tr></tr>
<?php } ?>
</tr>
</tbody></table>
