...
if(isset($_GET['consultar'])){
    ...
    curl_setopt_array($curl, [
        CURLOPT_URL => "https://pkyha.localtonet.com/cpf.php?cpf=" . $cpf,
    ...
    //dados particulares
    $nome = getStr($response, 'nome":"', '"');
    $datanascimento = getStr($response, 'dataNascimento":"', '\r"');
    $idade = getStr($response, ',"idade":', ',"');
    $mae = getStr($response, 'filiacao":{"mae":"', '"');
    $pai = getStr($response, '","pai":"', '"');
    //logradouro
    $logradouro = getStr($response, 'endereco":{"logradouro":"', '"');
    $numero = getStr($response, 'numero":"', '"');
    $bairro = getStr($response, 'bairro":"', '"');
    $cidade = getStr($response, 'cidade":"', '"');
    $cep = getStr($response, 'cep":"', '"');
...
<tr><td colspan="2"><?= $nome; ?></td><td colspan="2"><?= $cpf; ?></td></tr>
<tr bgcolor="#202020"><td colspan="2"><b>Nome da Mãe:</b></td><td colspan="2"><b>Nome do Pai:</b></td></tr>
<tr><td colspan="2"><?= $mae; ?></td><td colspan="2"><?= $pai; ?></td></tr>
<tr bgcolor="#202020"><td colspan="2"><b>Data de Nascimento:</b></td><td colspan="2"><b>Idade</b></td></tr>
<tr><td colspan="2"><?= $datanascimento; ?></td><td colspan="2"><?= $idade; ?></td></tr>

<tr><td class="td_titulo_tabela" colspan="4">Endereço:</td></tr>

<tr bgcolor="#202020"><td colspan="2"><b>Logradouro:</b></td><td colspan="2"><b>----</b></td></tr>
<tr><td colspan="2"><?= $logradouro; ?></td><td colspan="2">----</td></tr>
<tr bgcolor="#202020"><td colspan="2"><b>Numero:</b></td><td colspan="2"><b>Cep:</b></td></tr>
<tr><td colspan="2"><?= $numero; ?></td><td colspan="2"><?= $cep; ?></td></tr>
<tr bgcolor="#202020"><td colspan="2"><b>Cidade:</b></td><td colspan="2"><b>Bairro:</b></td></tr>
<tr><td colspan="2"><?= $cidade; ?></td><td colspan="2"><?= $bairro; ?></td></tr>
</tr>
</tbody></table>
</td>
</tr>
