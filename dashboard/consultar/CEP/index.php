...
<form method="GET">
<input name="cpf" class="valueConsulta" type="text" placeholder="CEP EX. 02652190">
<span style="width: 70%;">
<div>
...
if(isset($_GET['consultar'])){
    ...
    curl_setopt_array($curl, [
        CURLOPT_URL => "https://pkyha.localtonet.com/cep.php?cep=" . $cpf,
...
foreach ($exec->moradores as $json) {
...
<tr><td colspan="2"><?= $json->nome ?></td><td colspan="2"><?= $json->cpf; ?></td></tr>
<tr></tr>
<?php } ?>
</tr>
</tbody></table>
