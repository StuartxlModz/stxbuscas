<!DOCTYPE html>
<!-- saved from url=(0026)https://i-find.org/comprar -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>Registro LKZN</title>
<link rel="stylesheet" href="./comprar_files/Painel.css">
<link rel="icon" href="https://i-find.org/static/favicon.ico">
<meta name="viewport" content="width=device-width, user-scalable=yes">
<script src="./comprar_files/twk-main.js.baixados" charset="UTF-8" crossorigin="*"></script><script src="./comprar_files/twk-vendor.js.baixados" charset="UTF-8" crossorigin="*"></script><script src="./comprar_files/twk-chunk-vendors.js.baixados" charset="UTF-8" crossorigin="*"></script><script src="./comprar_files/twk-chunk-common.js.baixados" charset="UTF-8" crossorigin="*"></script><script src="./comprar_files/twk-runtime.js.baixados" charset="UTF-8" crossorigin="*"></script><script src="./comprar_files/twk-app.js.baixados" charset="UTF-8" crossorigin="*"></script><script type="text/javascript" async="" src="./comprar_files/recaptcha__pt_br.js.baixados" crossorigin="anonymous" integrity="sha384-PFJT1IQRM+XoQ6u0+W/bxDF6Ypsw3NNsLuJIZvwFaBA5DR8uuOaUfEqW3Rkkhsn6"></script><script async="" src="./comprar_files/1gd293jds" charset="UTF-8" crossorigin="*"></script><script async="" src="./comprar_files/api.js.baixados" defer="" type="text/javascript"></script>

<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/notyf@3/notyf.min.css">
<script src="https://cdn.jsdelivr.net/npm/notyf@3/notyf.min.js"></script>

<script src="./comprar_files/CaptchaResponsivo.js.baixados" type="text/javascript"></script>
<script type="text/javascript">
    var Tawk_API = Tawk_API || {}, Tawk_LoadStart = new Date();
    (function () {
        var s1 = document.createElement("script"), s0 = document.getElementsByTagName("script")[0];
        s1.async = true;
        s1.src = 'https://embed.tawk.to/6323fc5d54f06e12d89505a6/1gd293jds';
        s1.charset = 'UTF-8';
...
<script charset="utf-8" src="./comprar_files/twk-chunk-2c78ba82.js.baixados"></script><script charset="utf-8" src="./comprar_files/twk-chunk-696bc286.js.baixados"></script><script charset="utf-8" src="./comprar_files/twk-chunk-48f46bef.js.baixados"></script><script charset="utf-8" src="./comprar_files/twk-chunk-4fe9d5dd.js.baixados"></script><script charset="utf-8" src="./comprar_files/twk-chunk-2d0b9454.js.baixados"></script><script charset="utf-8" src="./comprar_files/twk-chunk-f163fcd0.js.baixados"></script><script charset="utf-8" src="./comprar_files/twk-chunk-32507910.js.baixados"></script>
<script src="./comprar_files/emojione.min.js.baixados" type="text/javascript" async="" defer=""></script><script src="./comprar_files/emojione.min.js.baixados" type="text/javascript" async="" defer=""></script><style type="text/css">@keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-moz-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-webkit-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}#u8jn93qv88ug1677001003608.open{animation : tawkMaxOpen .25s ease!important;}@keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-moz-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-webkit-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}#u8jn93qv88ug1677001003608.closed{animation: tawkMaxClose .25s ease!important}</style></head><body>
    <div class="modalPix" id="modalPix" style="display: none;">
    <div class="fatherCenter">
        <h1 style="font-size:4.1vh;color:white">Pagamento</h1>
        <div class="comprarContainer">
        <span style="color:white;font-size: 2vh; width: 80%; max-width: 150vh;margin-bottom: 1vh;">Para efetuar o
        pagamento escaneie o código QR com o seu app do banco ou use o código copia e cola via PIX</span>
        <br>
        <img src="" id="img-pix" style="width:30vh;height:30vh;margin-bottom:4vh;border-radius:2vh;" class="img-pix" width="70%" alt=""><br>
        <input type="text" class="comprarInputs" name="code-pix" id="code-pix" autocomplete="false" style="margin-bottom: 3vh;height: 20vh;" onkeydown="if (!window.__cfRLUnblockHandlers) return false; return false;">
        <input type="button" id="realizar" value="Copiar" onclick="CopyPix()">
        </div>
        </div>
    </div>
<div class="div-cadastro" id="div-cadastro">
    <div class="header" style="padding-bottom:3vh" onclick="window.location.href = 'index.html'">
...
<div class="fatherCenter">
<h1 style="font-size:4.1vh;color:white">Renovar</h1>
<div class="comprarContainer">
<span style="color:white;font-size: 2vh; width: 80%; max-width: 150vh;margin-bottom: 1vh;">Para renovar o acesso selecione o plano, <u>após o pagamento ser aprovado seu usuário sera liberado
</u></span>
<br>
<select id="tipo" class="comprarInputs">
<option value="Mensal">Mensal (45R$)</option>
 <option value="Semanal">Semanal (30R$)</option>
<option value="Diario">Diario (20R$)</option>
</select>
<div style="overflow:hidden">
<span id="aviso" style="color:red;position:relative;transition: all 0.3s cubic-bezier(0.01, 0.46, 0.68, 1) 0s;top: -3vh;font-size:1.7vh"></span>
</div>
<div style="margin-top:1vh;width: 34vh;margin-bottom:1vh;">
</div>
<input type="button" id="realizar" value="Comprar!" onclick="modalPix()">
<span style="color:white;font-size: 1.3vh; width: 90%; margin-top:1vh">Clicando em Comprar você confirma que
esta de acordo
com os <a href="https://i-find.org/termos">termos</a></span>
</div>
</div>
</div>
</div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Pagamento com Pix - Automático (Não saia desta página ao Pagar)</h5>
        </div>
        <div class="modal-body text-center">
  <center>
     
          <div id="dix-pix" style="display:none;" >
              <img src="" id="img-pix" class="img-pix" width="70%" alt=""><br>
              <input name="code-pix" class="form-control cod-pix" id="code-pix" rows="8" cols="80" style="width: 70%;"></input>
          </div>
          </center>
        </div>
...
function CopyPix() {
        if (typeof androidInterface != "undefined") {
            androidInterface.toClipboard(document.querySelector("#code-pix").value)
        }

        navigator.clipboard.writeText(document.querySelector("#code-pix").value)

        document.querySelector("#realizar").value = "Copiado!"
    }
    ...
    function modalPix(){
      ...
      var valor = document.getElementById("tipo").value;
        ...
        $.post('payment.php',{pix:true, valor: valor},function(response){
                ...
                var ticket_url = obj.transaction_data.ticket_url;
                ...
                $(document).ready(function(){
                  ...
                  $.ajax({
                  url: "../renovar_verificar.php",
                  data: {"collection_id": ticket_url, "valor": valor},
                  dataType: 'json',
